...
import "../../../styles/scss/standard_interface_module.scss";

export const StandardInterfacingModule = () => {
  return (
    <React.Fragment>
      <div className="standard-module-p-page">
        <div className="main_hero d-flex align-items-center mb-5">
          <div className="bg-image"></div>
          <div className="container">
            <h2 className="text-uppercase fs-5 title mt-5">products</h2>
            <h1 className="text-white">Standard Interfacing Module</h1>
          </div>
        </div>
